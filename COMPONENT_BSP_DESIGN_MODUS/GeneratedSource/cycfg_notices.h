...
#define CYCFG_NOTICES_H
    ...
    #error "Unexpected target MCU; expected CY8C4149AZI-S598. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif
#endif
